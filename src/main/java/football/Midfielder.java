...
public class Midfielder extends Player{
    /**
     * Constructor of class Midfielder with the specified attributes.
     ...
     */
    public Midfielder(String name, String surname, int side, int shooting, int dribbling, int passing, int defending, int aggression, int goalkeeping, int team_number, StatsTeam stats, int mentality, int motivation) {
    ...
    /**
     * Method player_moving for midfielder.
